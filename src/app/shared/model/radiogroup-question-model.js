...
var RadioGroupQuestionModel = (function (_super) {
    __extends(RadioGroupQuestionModel, _super);
    function RadioGroupQuestionModel() {
        _super.call(this, question_type_1.QuestionType.RadioGroup);
        this.options = [{ label: "Label", value: "Value" }];
    }
    RadioGroupQuestionModel.prototype.populateFromFormGroup = function (formGroup) {
    ...
    RadioGroupQuestionModel.prototype.createOptionFormGroup = function (option, fb) {
        return fb.group({
            Label: option.label,
            Value: option.value
        });
    };
    RadioGroupQuestionModel.prototype.toFormGroup = function (fb) {
        var _this = this;
        var requiredValidation = this.validations.find(function (validation) { return validation.validationType === 0 /* Required */; });
    ...
    return RadioGroupQuestionModel;
}(question_model_1.QuestionModel));
exports.RadioGroupQuestionModel = RadioGroupQuestionModel;
//# sourceMappingURL=radiogroup-question-model.js.map