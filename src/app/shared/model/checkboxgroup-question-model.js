...
var CheckboxgroupQuestionModel = (function (_super) {
    __extends(CheckboxgroupQuestionModel, _super);
    function CheckboxgroupQuestionModel() {
        _super.call(this, question_type_1.QuestionType.CheckBoxGroup);
        this.options = [{ label: "Label", value: "Value" }];
    }
    CheckboxgroupQuestionModel.prototype.populateFromFormGroup = function (formGroup) {
    ...
    CheckboxgroupQuestionModel.prototype.createOptionFormGroup = function (option, fb) {
        return fb.group({
            Label: option.label,
            Value: option.value
        });
    };
    CheckboxgroupQuestionModel.prototype.toFormGroup = function (fb) {
        var _this = this;
        var requiredValidation = this.validations.find(function (validation) { return validation.validationType === 0 /* Required */; });
    ...
    return CheckboxgroupQuestionModel;
}(question_model_1.QuestionModel));
exports.CheckboxgroupQuestionModel = CheckboxgroupQuestionModel;
//# sourceMappingURL=checkboxgroup-question-model.js.map